...
bool mouseDown = true; // Status mouse (apakah ditekan atau tidak)
...
void ukur(int lebar, int tinggi) {
    ...
    glTranslatef(0, 0, -340); // Menggeser pandangan ke belakang
...
void idle() {
    if (mouseDown) { // Jika mouse ditekan
        xrot += 0.0; // Menambah rotasi di sumbu X
        yrot += 0.0; // Menambah rotasi di sumbu Y
    }
